...
exports.generateOrganizationalInsight = generateOrganizationalInsight;
const aiEngine_1 = require("./aiEngine");
async function generateOrganizationalInsight({ semaforo, competencias, total }) {
    try {
        ...
        const scoreGlobal = Math.round((semaforo.verde * 100 +
            semaforo.amarillo * 65 +
            semaforo.rojo * 30) / (total || 1));
        const insight = await (0, aiEngine_1.generateAIReport)({
            type: "ORGANIZATIONAL",
            score: scoreGlobal,
